        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('status', function($row){
                    return $row->visibility ? '<i class="fas fa-eye text-primary" id="inactive-page" data="'.$row->id.'"></i>' : '<i class="fas fa-eye-slash" id="active-page" data="'.$row->id.'"></i>&nbsp;<a href="/'.$row->slug.'" target="_blank"><<i class="fas fa-external-link-alt"></i></a>';
                })
