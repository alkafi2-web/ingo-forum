              ...
              <div class="col-md-6 mb-3 mb-md-0">
                <div class="d-flex flex-stack">
                  <div class="d-flex align-items-center me-3">
                    ...
                    <div class="flex-grow-1">
                      <a href="#" class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">Active
                        Users</a>
                      <span class="text-gray-500 fw-semibold d-block fs-6">
              ...
              <div class="col-md-6">
                <div class="d-flex flex-stack">
                  <div class="d-flex align-items-center me-3">
                    ...
                    <div class="flex-grow-1">
                      <a href="#" class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">Users
                        Online</a>
                      <span class="text-gray-500 fw-semibold d-block fs-6">
            ...
            <div class="row gx-3">
              <div class="col-4">
                <div class="d-flex flex-column bg-light-info px-6 py-8 rounded-2 h-lg-100">
                  ...
                  <span
                    class="text-info fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1 mt-3">{{ $totalContactRequests }}</span>
              ...
              <div class="col-4">
                <div class="d-flex flex-column bg-light-dark px-6 py-8 rounded-2 h-lg-100">
                  ...
                  <span
                    class="text-dark fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1 mt-3">{{ $todayContactRequests }}</span>
              ...
              <div class="col-4">
                <div class="d-flex flex-column bg-light-warning px-6 py-8 rounded-2 h-lg-100">
                  ...
                  <span
                    class="text-warning fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1 mt-3">{{ $currentMonthContactRequests }}</span>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header pt-5 align-items-center">
            ...
            <a href="{{ route('post.create') }}" class="btn btn-sm fw-bold btn-primary"><i class="fas fa-plus"></i>
              &nbsp;Add New</a>
          </div>
          <div class="card-body pt-5">
            ...
            <div class="d-flex align-items-center mb-5">
              ...
              <a href="{{ route('single.post', ['categorySlug' => $post->category->slug, 'postSlug' => $post->slug]) }}"
                class="badge badge-light-primary fs-8 fw-bold"><i class="fas fa-external-link-alt text-primary"></i></a>
            </div>
            @empty
