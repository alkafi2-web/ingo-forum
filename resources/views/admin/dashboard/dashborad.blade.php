                            ...
                            <div class="row gx-3">
                                <div class="col-4">
                                    <div class="d-flex flex-column bg-light-primary px-6 py-8 rounded-2 h-lg-100">
                                        ...
                                        <span
                                            class="text-primary fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1 mt-3">{{ $totalMembers }}</span>
                                        <a href="{{ route('member.list') }}" class="text-primary fw-semibold fs-5">Total
                                            Members</a>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="d-flex flex-column bg-light-success px-6 py-8 rounded-2 h-lg-100">
                                        ...
                                        <span
                                            class="text-success fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1 mt-3">{{ $activeMembers }}</span>
                                        <a href="{{ route('member.list') }}" class="text-success fw-semibold fs-5">Active
                                            Members</a>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="d-flex flex-column bg-light-danger px-6 py-8 rounded-2 h-lg-100">
                                        ...
                                        <span
                                            class="text-danger fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1 mt-3">{{ $memberRequests }}</span>
                                        <a href="{{ route('member.request') }}" class="text-danger fw-semibold fs-5">Member
                                            Requests</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            @forelse($latestMembers as $member)
                                <div class="d-flex align-items-center mb-4">
                                    <div class="symbol symbol-50px me-5">
                                        <img src="{{ asset('public/frontend/images/member/' . ($member->info->logo ?? 'placeholder.jpg')) }}"
                                            alt="user" />
                                    </div>
                                    <div class="flex-grow-1">
                                        <a href="{{ route('member.view', ['id' => $member->id]) }}"
                                            class="text-gray-900 fw-bold text-hover-primary fs-6">{{ $member->info->organisation_name }}</a>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header pt-5 align-items-center">
                            ...
                            <a href="" class="btn btn-sm fw-bold btn-primary"><i class="fas fa-plus"></i> &nbsp;Add
                                New</a>
                        </div>
                        <div class="card-body pt-5">
                            <div class="row mb-3">
                                <div class="col-md-6 mb-3 mb-md-0">
                                    <div class="d-flex flex-stack">
                                        <div class="d-flex align-items-center me-3">
                                            ...
                                            <div class="flex-grow-1">
                                                <a href="#"
                                                    class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">Active
                                                    Users</a>
                                                <span class="text-gray-500 fw-semibold d-block fs-6">
                                ...
                                <div class="col-md-6">
                                    <div class="d-flex flex-stack">
                                        <div class="d-flex align-items-center me-3">
                                            ...
                                            <div class="flex-grow-1">
                                                <a href="#"
                                                    class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">Users
                                                    Online</a>
                                                <span class="text-gray-500 fw-semibold d-block fs-6">
                                ...
                                <div class="d-flex align-items-center bg-light-success rounded p-3 mb-3">
                                    <div class="flex-grow-1 me-2">
                                        <a href="javascript:void(0)"
                                            class="fw-bold text-gray-800 text-hover-primary fs-6"><i
                                                class="fas fa-hand-point-right fw-bold text-gray-800"></i>&nbsp;{{ $activity->activity }}</a>
                                        <span class="text-muted fw-semibold d-block"><i
                                                class="fas fa-user"></i>&nbsp;{{ $activity->user->name ?? $activity->member->organisation_name }}
                                            &nbsp;&nbsp; <i
                                                class="fab fa-chrome"></i>&nbsp;{{ $activity->ip_address }}</span>
                                    </div>
                                    <span
                                        class="fw-bold text-success py-1">{{ $activity->created_at->diffForHumans() }}</span>
                                </div>
                            @empty
                            ...
                            <div class="row gx-3">
                                <div class="col-3">
                                    <div class="d-flex flex-column bg-light-info px-6 py-8 rounded-2 h-lg-100">
                                        <span
                                            class="text-info fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1 mt-3">{{ $totalVisitors }}</span>
                                ...
                                <div class="col-3">
                                    <div class="d-flex flex-column bg-light-dark px-6 py-8 rounded-2 h-lg-100">
                                        <span
                                            class="text-dark fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1 mt-3">{{ $todayVisitors }}</span>
                                ...
                                <div class="col-3">
                                    <div class="d-flex flex-column bg-light-warning px-6 py-8 rounded-2 h-lg-100">
                                        <span
                                            class="text-warning fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1 mt-3">{{ $uniqueVisitors }}</span>
                                ...
                                <div class="col-3">
                                    <div class="d-flex flex-column bg-light-primary px-6 py-8 rounded-2 h-lg-100">
                                        <span
                                            class="text-primary fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1 mt-3">{{ $newVisitors }}</span>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header pt-5 align-items-center">
                            ...
                            <a href="{{ route('post.create') }}" class="btn btn-sm fw-bold btn-primary"><i
                                    class="fas fa-plus"></i>
                                &nbsp;Add New</a>
                        </div>
                        <div class="card-body pt-5">
                            @forelse($latestPosts as $post)
                                <div class="d-flex align-items-center mb-5">
                                    ...
                                    <div class="flex-grow-1 mx-3">
                                        <a href="{{ route('single.post', ['categorySlug' => $post->category->slug, 'postSlug' => $post->slug]) }}"
                                            class="text-gray-800 text-hover-primary fw-bold fs-6">{{ $post->title }}</a>
                                    ...
                                    <a href="{{ route('single.post', ['categorySlug' => $post->category->slug, 'postSlug' => $post->slug]) }}"
                                        class="badge badge-light-primary fs-8 fw-bold"><i
                                            class="fas fa-external-link-alt text-primary"></i></a>
                                </div>
                            @empty
