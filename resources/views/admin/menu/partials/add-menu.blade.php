        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <div class="form-check mb-2">
                    <input class="form-check-input menu-type" type="radio" name="menu_type" id="menu_type_page"
                        value="page">
                    <label class="form-check-label" for="menu_type_page">Pages</label>
                </div>
                <div class="form-check mb-2">
                    <input class="form-check-input menu-type" type="radio" name="menu_type" id="menu_type_post"
                        value="post">
                    <label class="form-check-label" for="menu_type_post">Post Type</label>
                </div>
                <div class="form-check mb-2">
                    <input class="form-check-input menu-type" type="radio" name="menu_type" id="menu_type_route"
                        value="route">
                    <label class="form-check-label" for="menu_type_route">Route</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input menu-type" type="radio" name="menu_type" id="menu_type_url"
                        value="url">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            $('#menu-submit').prop('disabled', false);
