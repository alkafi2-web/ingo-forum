...
@push('custom-js')
    <script>
        $(document).ready(function() {
            var table = $('#publication-category-data').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "{{ route('publication.category') }}",
                    type: 'GET',
                    headers: {
        ...
        $(document).on('click', '.edit', function(e) {
            ...
            var url = "{{ route('publication.category.edit') }}";
            $.ajax({
                url: url,
                ...
                success: function(response) {
                    ...
                    $('#add-header').text('Update Publication Category');
        ...
        $(document).on('click', '.delete', function(e) {
            ...
            var id = $(this).attr('data-id');
            var url = "{{ route('publication.category.delete') }}";
            // Show SweetAlert confirmation dialog
            Swal.fire({
                title: 'Are you sure?',
                text: 'This action will delete this publication category!',
                icon: 'warning',
        ...
        $(document).on('click', '.status', function(e) {
            ...
            var url = "{{ route('publication.category.status') }}";
            // Show SweetAlert confirmation dialog
            Swal.fire({
                title: 'Are you sure?',
                text: 'This action will change status of this publication category!',
                icon: 'warning',
                showCancelButton: true,
