        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('publication.create') }}" class="btn btn-primary"><span><i
                                class="fas fa-plus-square"></i></span>Add Publication</a>
                </div>

                <div class="card-body pt-3">
                    <div id="toggle-filters-container" style="cursor: pointer;" class="d-inline-block">
                        <i id="toggle-filters" class="fas fa-filter text-primary fs-2" style=""></i>
                        <span class="fs-2 text-primary ml-2">Filter</span>
                    </div>
                    <div class="col-md-12 mb-3 border-bottom" id="filter-section" style="display: none;">
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <div class="row my-3">
                            ...
                            <div class="col-md-4">
                                <button id="reset-filters" class="btn btn-secondary mt-6"><i
                                        class="fas fa-sync-alt"></i>Refresh Filter</button>
                            </div>
                        </div>
                    </div>
