    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div data-kt-menu-trigger="click"
                    ...
                    <div
                        ...
                        <a class="menu-item menu-accordion" href="{{ route('publication.category') }}">
                            <span class="menu-link {{ Route::currentRouteName() == 'publication.category' ? 'active' : '' }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Category</span>
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{Route::currentRouteName() == 'admin.page' || Route::currentRouteName() == 'admin.page.create' ? 'hover show' : '' }}">
                    <span class="menu-link">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg-->
                            <span class="svg-icon svg-icon-2">
                    ...
                    <div class="menu-sub menu-sub-accordion  {{Route::currentRouteName() == 'admin.page.create' ? 'hover show' : '' }}">
                        <a class="menu-item menu-accordion" href="{{ route('admin.page.create') }}">
                            <span class="menu-link {{ Route::currentRouteName() == 'admin.page.create' ? 'active' : '' }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <a class="menu-item menu-accordion" href="{{ route('admin.page') }}">
                            <span class="menu-link {{ Route::currentRouteName() == 'admin.page' ? 'active' : '' }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{Route::currentRouteName() == 'banner' || Route::currentRouteName() == 'aboutus' || Route::currentRouteName() == 'faqs' ? 'hover show' : '' }}">
                    <span class="menu-link">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg-->
                            <span class="svg-icon svg-icon-2">
                    ...
                    <div class="menu-sub menu-sub-accordion  {{Route::currentRouteName() == 'banner' || Route::currentRouteName() == 'aboutus' || Route::currentRouteName() == 'faqs' ? 'hover show' : '' }}">
