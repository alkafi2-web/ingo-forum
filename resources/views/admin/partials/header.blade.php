                ...
                <div class="d-flex align-items-stretch flex-shrink-0">
                    ...
                    <div class="d-flex align-items-center ms-1 ms-lg-3">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px"
                            ...
                            <div class="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10"
                                style="background-image:url('{{ asset('public/admin/media/misc/pattern-1.jpg') }}')">
                                <!--begin::Title-->
                    ...
                    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                        ...
                        <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click"
                            ...
                            <img src="{{ Auth::guard('admin')->user()->image ? asset('public/frontend/images/profile/' . Auth::guard('admin')->user()->image) : asset('public/frontend/images/member/placeholder.jpg') }}" alt="user" />
                        </div>
                        <!--begin::Menu-->
                            ...
                            <div class="menu-item px-3">
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="symbol symbol-50px me-5">
                                        <img alt="Logo"
                                            src="{{ Auth::guard('admin')->user()->image ? asset('public/frontend/images/profile/' . Auth::guard('admin')->user()->image) : asset('public/frontend/images/member/placeholder.jpg') }}" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Username-->
