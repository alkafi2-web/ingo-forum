...
@push('custom-js')
    <script>
        $(document).ready(function() {
            var table = $('#file-subcategory-data').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "{{ route('file.subcategory') }}",
                    type: 'GET',
                    headers: {
        ...
        $(document).on('click', '.edit', function(e) {
            ...
            var url = "{{ route('file.subcategory.edit') }}";
            $.ajax({
                url: url,
                ...
                success: function(response) {
                    ...
                    $('#add-header').text('Update File Sub Category');
                    $('#name').val(subcategory.name);
                    $('#category').val(subcategory.parent_id).trigger('change');
        ...
        $(document).on('click', '.delete', function(e) {
            ...
            var id = $(this).attr('data-id');
            var url = "{{ route('file.subcategory.delete') }}";
            // Show SweetAlert confirmation dialog
            Swal.fire({
                title: 'Are you sure?',
                text: 'This action will delete this file sub category!',
                icon: 'warning',
        ...
        $(document).on('click', '.status', function(e) {
            ...
            var url = "{{ route('file.subcategory.status') }}";
            // Show SweetAlert confirmation dialog
            Swal.fire({
                title: 'Are you sure?',
                text: 'This action will change status of this file sub category!',
                icon: 'warning',
                showCancelButton: true,
