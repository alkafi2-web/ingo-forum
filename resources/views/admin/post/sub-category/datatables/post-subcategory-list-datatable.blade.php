...
@push('custom-js')
    <script>
        $(document).ready(function() {
            var table = $('#post-subcategory-data').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
        ...
        $(document).on('click', '.edit', function(e) {
            ...
            var url = "{{ route('subcategory.edit') }}";
            $.ajax({
                url: url,
        ...
        $(document).on('click', '.delete', function(e) {
            ...
            Swal.fire({
                title: 'Are you sure?',
                text: 'This action will delete this post sub category!',
                icon: 'warning',
        ...
        $(document).on('click', '.status', function(e) {
            ...
            var url = "{{ route('subcategory.status') }}";
            // Show SweetAlert confirmation dialog
            Swal.fire({
                title: 'Are you sure?',
                text: 'This action will change status of this sub category!',
                icon: 'warning',
                showCancelButton: true,
