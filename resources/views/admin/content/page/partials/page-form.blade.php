<form id="pageForm" action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="page_title" name="page_title"
                    value="{{ $page->title ?? old('page_title') }}">
            </div>
        </div>
    </div>
    <div class="row mb-3">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="page_slug" name="page_slug"
                    value="{{ $page->slug ?? old('page_slug') }}" data-page-id="{{ $page->id ?? '' }}">
    ...
    <button id="page-submit" type="submit" class="btn btn-primary mt-3">
        <span id="spinner-submit" class="spinner-border spinner-border-sm me-2 d-none" role="status"
            aria-hidden="true"></span>
        <i class="fas fa-upload"></i> Submit
    </button>

    <button id="page-update" type="submit" class="btn btn-primary mt-3 d-none">
